...
function Home() {
  ...
  return (
    <>
      <section className="bg-auto my-4">
        <div className="grid max-w-screen-7xl px-4 py-x4 mx-auto lg:gap-8 xl:gap-0 lg:py-4 lg:grid-cols-12">
          <div className="ml-7mr-auto place-self-center lg:col-span-7">
            ...
            <a
              ...
              title="Explore o universo de zelda"
              className="inline-flex items-center cursor-pointer justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border border-gray-300 rounded-lg hover:bg-amber-200 focus:ring-4 focus:ring-amber-200 dark:text-white dark:border-gray-70 hover:text-amber-900 hover:scale-110 transition-transform"
            >
              Explorar
            </a>
          </div>
